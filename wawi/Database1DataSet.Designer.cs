...
namespace wawi {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class ArtikelDataTable : global::System.Data.TypedTableBase<ArtikelRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ArtikelRow AddArtikelRow(string Name) {
        ...
        public partial class ArtikelRow : global::System.Data.DataRow {
            ...
            public string Name {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Der Wert für Spalte Name in Tabelle Artikel ist DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsNameNull() {
                return this.IsNull(this.tableArtikel.NameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetNameNull() {
                this[this.tableArtikel.NameColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace wawi.Database1DataSetTableAdapters {
    ...
    public partial class ArtikelTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Artikel] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 A" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Artikel] ([Name]) VALUES (@Name);\r\nSELECT Id, Name FROM Artike" +
                "l WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Name", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Artikel] SET [Name] = @Name WHERE (([Id] = @Original_Id) AND ((@IsN" +
                "ull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)));\r\nSELECT Id, Nam" +
                "e FROM Artikel WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name FROM dbo.Artikel";
        ...
        public virtual int Fill(Database1DataSet.ArtikelDataTable dataTable) {
        ...
        public virtual Database1DataSet.ArtikelDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.ArtikelDataTable dataTable = new Database1DataSet.ArtikelDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.ArtikelDataTable dataTable) {
